...
//  }	
//}
//class CartItem extends Service {
//	int cartId ;
//    int finalprice;
//
//    public CartItem(int cartId, int id, String service, String name, String descreption, String cost, int finalprice) {
//        super(id, service, name, descreption, cost);
...
//List<Offer> offer ;
//Stack<CartItem> cartitem;
//
//public  onlineservice() {
//  this.users = new ArrayList<>();
//  this.service= new ArrayList<>();
//  this.offer= new ArrayList<>(); 
// this.cartitem =new Stack<>();
//}
...
//  System.out.println("4. Scheduled Service");
...
//           
//          CartItem cartItem = new CartItem( cartID,serviceid, service,servicename,description,cost,finalprice);
//          
//          addcart( cartItem) ;
...
//                System.out.println(" Service name: " + cart.descreption);
//                System.out.println(" Service name: " + cart.cost);
//                System.out.println(" Service name: " + cart.finalprice);
//              
//                
//                System.out.println("-------------------------");
